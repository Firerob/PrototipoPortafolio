...
import { Flecha, Whatsapp } from './Dibujos.jsx'
...
const reglas = {
  ...
  mensaje: (v) =>
    v.trim().length >= 10 ||
    'Cuénteme algo más sobre el encargo (mínimo 10 caracteres).',
}
...
export default function Contacto() {
  ...
  const enviar = (ev) => {
    ...
    setEstado('Recibido. Le respondo dentro de dos días hábiles con un rango de honorarios para su caso.')
      ...
      <div className="wrap">
        <div className="g12">
          ...
          <div className="c-datos">
            ...
            <TituloPartido texto="Cuénteme su encargo" className="h2" />

            <Revelar as="p" className="lead" retardo={0.06}>
              Respondo dentro de dos días hábiles, siempre yo. La primera
              visita a terreno no se cobra; de ahí salen superficie, plazo y
              costo por m² antes de que usted firme nada.
            </Revelar>
            ...
            <Revelar className="datos">
              ...
              <div>
                ...
                <a href="https://wa.me/56964218830?text=Hola%20Marina%2C%20quisiera%20consultar%20por%20un%20encargo"
                   className="valor sub con-icono"
                   target="_blank" rel="noopener noreferrer">
                  <Whatsapp /> +56 9 6421 8830
                </a>
                <p className="ayuda">Lunes a viernes, de 9 a 18 h.</p>
              </div>
              <div>
          ...
          >
            ...
            <Campo id="email" etiqueta="Correo" tipo="email" valor={valores.email}
                   ayuda="Le respondo dentro de dos días hábiles."
            ...
            <Campo id="mensaje" etiqueta="Mensaje" tipo="textarea" valor={valores.mensaje}
                   ayuda="Comuna, metros cuadrados aproximados y cuándo quiere partir. Con eso le doy un rango de honorarios."
